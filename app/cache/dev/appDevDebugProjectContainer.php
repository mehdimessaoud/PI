...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.user.provider.concrete.chainprovider' => 'getSecurity_User_Provider_Concrete_ChainproviderService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'TestFosUser', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_548f3235b5ea280d7d007d63bff79c5d8962915e0eb5945462d6ed7fb395e818');
    ...
    {
        return $this->services['fos_facebook.api'] = new \FOS\FacebookBundle\Facebook\FacebookSessionPersistence(array('appId' => '1740792506135917', 'secret' => 'bd97e4981e7228dca2bb46a4555c715b', 'cookie' => true, 'domain' => NULL), $this->get('session'));
    }
    ...
    {
        return $this->services['fos_facebook.helper'] = new \FOS\FacebookBundle\Templating\Helper\FacebookHelper($this->get('templating'), $this->get('fos_facebook.api'), $this->get('router'), true, 'en_US', array(0 => 'email', 1 => 'user_hometown', 2 => 'user_location'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \MyApp\UserBundle\Security\User\Provider\FacebookProvider A MyApp\UserBundle\Security\User\Provider\FacebookProvider instance.
     */
    protected function getFosFacebook_User_LoginService()
    {
        return $this->services['fos_facebook.user.login'] = new \MyApp\UserBundle\Security\User\Provider\FacebookProvider($this->get('fos_facebook.api'), $this->get('fos_user.user_manager'), $this->get('validator'), $this);
    }
    ...
    {
        return $this->services['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('MyApp\\UserBundle\\Entity\\UserGroup');
    }
    ...
    {
        return $this->services['fos_user.group_manager'] = new \FOS\UserBundle\Doctrine\GroupManager($this->get('fos_user.object_manager'), 'MyApp\\UserBundle\\Entity\\UserGroup');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('webmaster@example.com' => 'CrowdriseAdmin'), 'resetting' => array('webmaster@example.com' => 'CrowdriseAdmin'))));
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('fos_user.object_manager'), 'MyApp\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_AdminService()
    {
        ...
        $f->setOptions(array('login_path' => '/admin/login', 'default_target_path' => '/admin/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.chainprovider'), 2 => $this->get('fos_facebook.user.login'), 3 => $this->get('security.user.provider.concrete.in_memory')), 'admin', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'admin', $f, $g, array('check_path' => '/admin/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'admin', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/admin/login', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c, 1 => $b), 'mySuperDuperKey', 'main', array('lifetime' => 4147200, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $d);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $f, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($f, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $l->setOptions(array('login_path' => '/user/login', 'default_target_path' => '/profil', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $l->setProviderKey('main');

        $m = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $f, array(), $d);
        $m->setOptions(array('login_path' => '/user/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $n = new \FOS\FacebookBundle\Security\Firewall\FacebookListener($a, $h, $i, $f, 'main', $l, $m, array('app_url' => 'http://apps.facebook.com/this-is-my-awesome-app', 'server_url' => 'http://mywebsite.com', 'check_path' => '/facebook/login_check', 'use_forward' => false, 'require_previous_session' => true, 'display' => 'page', 'create_user_if_not_exists' => false, 'redirect_to_facebook_login' => true), $d, $e);
        $n->setRememberMeServices($j);

        $o = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($f, array());
        $o->setOptions(array('login_path' => '/login', 'default_target_path' => '/profil', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $o->setProviderKey('main');

        $p = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($g, $f, array(), $d);
        $p->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $q = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $h, $i, $f, 'main', $o, $p, array('use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $d, $e, $this->get('form.csrf_provider'));
        $q->setRememberMeServices($j);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.chainprovider'), 2 => $c, 3 => $this->get('security.user.provider.concrete.in_memory')), 'main', $d, $e), 2 => $k, 3 => $n, 4 => $q, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $j, $h, $d, $e, true), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5721b5136d45b3.01109200', $d, $h), 7 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $f, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $f, '/login', false), NULL, NULL, $d));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('mohamedmehdi.messaoud@esprit.tn');
        $a->setPassword('K33PmOving');
        $a->setAuthMode('login');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \FOS\FacebookBundle\Security\Authentication\Provider\FacebookProvider('main', $this->get('fos_facebook.api'), $this->get('fos_facebook.user.login'), $b, false), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($b, 'mySuperDuperKey', 'main'), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5721b5136d45b3.01109200')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }

    /**
     * Gets the 'security.user.provider.concrete.chainprovider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['security.user.provider.concrete.chainprovider'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('fos_facebook.user.login')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'mohamedmehdi.messaoud@esprit.tn',
            'swiftmailer.mailer.default.transport.smtp.password' => 'K33PmOving',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'webmaster@example.com' => 'CrowdriseAdmin',
            ),
            ...
            'fos_user.model.group.class' => 'MyApp\\UserBundle\\Entity\\UserGroup',
            ...
            'fos_facebook.app_id' => '1740792506135917',
            'fos_facebook.secret' => 'bd97e4981e7228dca2bb46a4555c715b',
