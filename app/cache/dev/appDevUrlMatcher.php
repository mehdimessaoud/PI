    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/facebook/log')) {
            ...
            if ($pathinfo === '/facebook/login_check') {
                return array (  '_controller' => 'MyApp\\UserBundle\\Controller\\UserController::loginFbAction',  '_route' => '_security_check_facebook',);
            }
        ...
        if ($pathinfo === '/user/couple/facebook') {
            return array (  '_controller' => 'MyApp\\UserBundle\\Controller\\UserController::connectFacebookWithAccountAction',  '_route' => 'user_couple_fb_with_account',);
        }
        ...
        if (0 === strpos($pathinfo, '/enregistrer')) {
            // fos_user_registration_register
            if (rtrim($pathinfo, '/') === '/enregistrer') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
            ...
            if (0 === strpos($pathinfo, '/enregistrer/c')) {
                // fos_user_registration_check_email
                if ($pathinfo === '/enregistrer/check-email') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/enregistrer/confirm')) {
                    // fos_user_registration_confirm
                    if (preg_match('#^/enregistrer/confirm/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if ($pathinfo === '/enregistrer/confirmed') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
        ...
        if ($pathinfo === '/Mot de passe oublié/change-password') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
        ...
        if (0 === strpos($pathinfo, '/admin/log')) {
            if (0 === strpos($pathinfo, '/admin/login')) {
                ...
                if ($pathinfo === '/admin/login') {
                    return array (  '_controller' => 'MyApp\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'admin_login',);
                }

                // admin_check
                if ($pathinfo === '/admin/login_check') {
                    return array (  '_controller' => 'MyApp\\UserBundle\\Controller\\SecurityController::checkAction',  '_route' => 'admin_check',);
                }
            ...
            if ($pathinfo === '/admin/logout') {
                return array (  '_controller' => 'MyApp\\UserBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'admin_logout',);
            }
